...
#YOU CAN CHANGE THIS KEYWORDS 
#THE SCRIPT WILL DOWNLOAD ONLY THOSE ATTACHMENTS WHICH START WITH THESE KEYWORDS
...
#I CAN CHANGE IT TO DOWNLOAD FILES TILL A SPECIFIED DATE TOO 
...
for emailid in reversed(items):
    if count < 3:
		...
		#I CAN CHANGE THIS TO JUST DOWNLOAD THE FILE AND DONT CREATE THE SUBFOLDERS    
